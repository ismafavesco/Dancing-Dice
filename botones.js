...
play.addEventListener('click', ()=>{
    ...
    dado.style.animation = "dembowyala 1.1s infinite 5.5s";
    dadoc1.style.animation = "dembowyalac1 1.1s infinite 5.5s";
    dadoc2.style.animation = "dembowyalac2 1.1s infinite 5.5s";
});
